...
```{r}
cure_func(colon_data,as.integer(19))
...
cure_data<-CURE(colon_data_df,19)
...
cc <- consensus_cluster(colon_data, nk=19, reps = 10, algorithms = c("CURE", "BIRCH"), progress = T, prep.data = "full")
cc
```
